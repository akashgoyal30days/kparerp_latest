    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: isdateopen == false?Text('Outstanding Report'):ishtmloaded==false?Text('Select Date', style: TextStyle(color: Colors.black)):Text('Ledger', style: TextStyle(color: Colors.black),),
            leading: IconButton(
